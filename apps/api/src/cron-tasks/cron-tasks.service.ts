...
export class CronTasksService {
  ...
  async sendDailyWashSaleNotifications() {
    ...
    await this.notificationService.sendWashSaleNotifications({ date: new Date() })
  }
  ...
  async sendDailyPortfolioNotifications() {
    ...
    await this.notificationService.sendPortfolioNotifications(HarvestNotificationFrequency.DAILY)
  }
  ...
  async sendWeeklyPortfolioNotifications() {
    ...
    await this.notificationService.sendPortfolioNotifications(HarvestNotificationFrequency.WEEKLY)
  }
  ...
  async sendMonthlyPortfolioNotifications() {
    ...
    await this.notificationService.sendPortfolioNotifications(HarvestNotificationFrequency.MONTHLY)
  }
  ...
  async sendQuarterlyPortfolioNotifications() {
    ...
    await this.notificationService.sendPortfolioNotifications(HarvestNotificationFrequency.QUARTERLY)
  }
}
