...
export interface AccountRealizedPAndLHistory {
  ...
  plaidMergeId: string;
  portfolioId: string;
  profitAndLossType: "ACCOUNT_FEE" | "CONTRIBUTION" | "DEPOSIT" | "DISTRIBUTION" | "DIVIDEND" | "DIVIDEND_REINVESTMENT" | "FUND_FEE" | "INTEREST" | "INTEREST_REINVESTMENT" | "LOAN_PAYMENT" | "LONG_TERM_CAPITAL_GAIN" | "MANAGEMENT_FEE" | "MARGIN_EXPENSE" | "NON_QUALIFIED_DIVIDEND" | "NON_RESIDENT_TAX" | "QUALIFIED_DIVIDEND" | "RETURN_OF_PRINCIPAL" | "SHORT_TERM_CAPITAL_GAIN" | "STOCK_DISTRIBUTION" | "TAX_WITHHELD" | "UNQUALIFIED_GAIN" | "WITHDRAWAL";
...
export interface PositionSnapshotOnPortfolioBalanceSnapshot {
  portfolioBalanceSnapshotId: Int8;
  positionSnapshotId: string;
}
