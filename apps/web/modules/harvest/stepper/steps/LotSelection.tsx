...
const tableLabel: Record<HarvestType, string> = {
	...
	[HarvestType.NoOpportunityEmpty]: 'Select Positions',
	[HarvestType.NoOpportunityGains]: 'Select Gains',
	[HarvestType.NoOpportunityLosses]: 'Select Losses',
};
	...
	return (
		<>
			<DataTable
				...
				columns={columns}
				onUpdateCell={(rowIndex, _columnId, value) => {
