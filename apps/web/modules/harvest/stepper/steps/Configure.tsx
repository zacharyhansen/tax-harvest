...
export default function Configure({ harvestId }: ConfigureProps) {
    ...
    <Card key={transaction.id} className="overflow-hidden">
      ...
      <CardContent className="p-0">
        <div className="flex flex-col">
          <div className="bg-red-50 p-2 px-4 dark:bg-red-900/20">
          ...
          {transaction.replacementTransactionItem ? (
            <div className="bg-green-50 p-2 px-4 dark:bg-green-900/20">
              <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                <div>
                  <p className="text-muted-foreground text-sm font-medium">
                    Action
          ...
          >
            ...
            >
              {transaction.revertDate ? (
                format(transaction.revertDate, 'PPP')
              ) : (
