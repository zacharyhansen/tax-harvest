                      ...
                      {lots.map((lot, index) => {
                        ...
                        return (
                          <tr key={lot.id || index} className="border-b">
                            <td className="p-2 font-mono text-xs">{lot.id || `lot-${index}`}</td>
                            <td className="p-2 font-mono">{lot.remainingQty || lot.originalQty}</td>
                            <td className="p-2 font-mono">${lot.costBasis || 'N/A'}</td>
                            <td className="p-2 font-mono">${lot.value || 'N/A'}</td>
                            ...
                            <td className={`p-2 font-mono ${gainPct >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                              {lot.gainTotalPct ? `${gainPct.toFixed(2)}%` : 'N/A'}
                            </td>
                            <td className="p-2">
                              {lot.taxGain && (
                            ...
                            <td className={`p-2 font-mono ${
                              lot.dollarPerSharePnL 
                                ? (parseFloat(lot.dollarPerSharePnL) >= 0 ? 'text-green-600' : 'text-red-600')
                                : ''
                            }`}>
