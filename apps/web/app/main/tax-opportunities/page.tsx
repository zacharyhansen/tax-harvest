...
export default function TaxOpportunitiesPage() {
	...
	return (
		<Protect feature="harvest_recommendations" fallback={<SeePaymentPlans />}>
			<div
				ref={scrollRef}
				className="container mx-auto max-w-6xl space-y-4 px-4 h-full overflow-y-auto w-full mb-8"
			>
				<motion.div
					ref={containerRef}
					className=" space-y-4"
				...
				>
					{/* Page Header */}
					<motion.div
						className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mt-8"
													...
													<div>
														...
														<div
															className={cn(
																'font-semibold',
																MoneyUtil.colored(
																	harvestEvalResult.summary.realized
																		.gainTotal ?? 0,
																),
															)}
														>
											...
											<div className="flex flex-col">
												...
												<span
													className={cn(
														'mt-1 text-2xl font-semibold sm:text-3xl',
														MoneyUtil.colored(
															harvestEvalResult.summary.unrealized.gainTotal ??
																0,
														),
													)}
												>
											...
											<div className="flex flex-col">
												...
												<span
													className={cn(
														'mt-1 text-2xl font-semibold sm:text-3xl',
														MoneyUtil.colored(
															harvestEvalResult.summary.unrealized.lossTotal ??
																0,
														),
													)}
												>
												...
												<div className="flex flex-col">
													...
													<span
														className={cn(
															...
															MoneyUtil.colored(
																harvestEvalResult.summary
																	.includingCurrentHarvest.realized.gainTotal ??
																	0,
															),
														)}
													>
												...
												<div className="flex flex-col">
													...
													<span
														className={cn(
															...
															MoneyUtil.colored(
																harvestEvalResult.summary
																	.includingCurrentHarvest.unrealized
																	.gainTotal ?? 0,
															),
														)}
													>
