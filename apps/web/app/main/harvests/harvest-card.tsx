                ...
                <div className="mt-4 space-y-4 border-t-2 pt-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      rebuy the stock. If you sell the stock after Today+1,
                      change your reminder date to be 31 days after you sell the
                      stock to avoid the IRS Wash Sale rule
                    </p>
                  </div>
                  <div className="flex flex-col items-start gap-3">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      your brokerage to sell this position. On June 24 at 3PM
                      EST, this lot will expire and be re-included in your
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Are you sure you want to delete this harvest? This
                          will restore the opportunity to the Tax Opportunities
                          page.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
