...
} & Omit<React.HTMLAttributes<HTMLButtonElement>, 'onChange'> & VariantProps<typeof multiSelectVariants> & BaseInputProps;

export const DateRangePicker = (
  { ref, id = 'calendar-date-picker', className, value: date, closeOnSelect = false, numberOfMonths = 2, yearsRange = 10, onChange: onDateSelect, variant, placeholder, ...props }: DateRangePickerProps & { ref?: React.RefObject<HTMLButtonElement | null> },
) => {
