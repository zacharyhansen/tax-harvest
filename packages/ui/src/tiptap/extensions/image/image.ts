/** biome-ignore-all lint/correctness/noUnusedVariables: <ok> */
...
declare module '@tiptap/react' {
	// @ts-expect-error - this is a custom extension
...
export const Image = TiptapImage.extend<CustomImageOptions>({
	...
	// 		downloadImage: (attributes: ImageActionProps) => () => {
	...
	// 		copyImage: (attributes: ImageActionProps) => () => {
	...
	// 		copyLink: (attributes: ImageActionProps) => () => {
